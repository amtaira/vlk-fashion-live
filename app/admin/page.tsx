'use client';
// Force Next.js to skip pre-rendering this page during the build
                ...
                {products.map(p => (
                  <div key={p.id} className="border border-white/5 p-4 flex items-center justify-between bg-black/50">
                    <div className="flex items-center gap-4">
                      <div className="w-12 h-12 bg-zinc-900 overflow-hidden">{p.image_url && <img src={p.image_url} alt="" className="w-full h-full object-cover grayscale"/>}</div>
                      <div>
