...
export default function AdminPortal() {
  ...
  const addProduct = async () => {
    if(!pName || !pPrice || !catId || !pImageUrl) return alert("MISSING DATA");
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <aside className="col-span-1 bg-black border border-white/5 p-6 md:p-8 space-y-6 h-fit order-2 md:order-1">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <input placeholder="Base Image URL (Main)" value={pImageUrl} onChange={(e)=>setPImageUrl(e.target.value)} className="w-full bg-transparent border-b border-white/10 py-2 text-[10px] text-white outline-none"/>
                    <p className="text-[7px] mt-2 opacity-30 leading-relaxed uppercase">
                      *Note: Ensure variations follow naming: <br/> 
                      [filename]-BLACK.png, [filename]-GOLD.png
                    </p>
                  </div>
